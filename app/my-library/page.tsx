...
import { books, type ReadingStatus, uniqueAuthors, uniqueCategories } from "@/lib/mock-data";
            ...
            {filteredBooks.length > 0 && viewMode === "grid" && (
              <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
                {filteredBooks.map((book) => (
                  ...
                  >
                    <div
                      className={`mb-3 h-44 w-full rounded-md bg-linear-to-br ${toneClass[book.coverTone]}`}
                    />
